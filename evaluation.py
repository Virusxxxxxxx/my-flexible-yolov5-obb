...
def evaluation(detoutput, rawImagePath, rawLabelPath):
    ...
    for classname in classnames:
        ...
        l1, = plt.plot(class_rec[0], class_prec[0], color='orangered', linestyle='-', linewidth=1)
...
if __name__ == '__main__':
    ...
    evaluation(
        ...
        rawImagePath=r'../datasets/dota_interest/row_DOTA_labels',
        rawLabelPath=r'../datasets/dota_interest/row_DOTA_labels/{:s}.txt'
    )
